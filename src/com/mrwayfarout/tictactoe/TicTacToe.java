...
public class TicTacToe implements Runnable {
	...
	private int[][] wins = new int[][] { { 0, 1, 2 }, { 2, 3, 4 }, { 1, 2, 3 }, { 5, 6, 7 }, { 7, 8, 9 }, { 6, 7, 8 }, { 10, 11, 12 }, { 12, 13, 14 },
	{ 11, 12, 13 }, { 15, 16, 17 }, { 16, 17, 18 }, { 17, 18, 19 }, { 20, 21, 22 }, { 22, 23, 24 }, { 0, 5, 10 }, { 5, 10, 15 },
	{ 10, 15, 20 }, { 1, 6, 11 }, { 6, 11, 16 }, { 11, 16, 21 }, { 2, 7, 12 }, { 7, 12, 17 }, { 12, 17, 22 }, { 3, 8, 13 },
	{ 8, 13, 18 }, { 13, 18, 23 }, { 4, 9, 14 }, { 9, 14, 19 }, { 14, 19, 24 }, { 0, 6, 12 }, { 6, 12, 18 }, { 12, 18, 24 },
	{ 1, 7, 13 }, { 7, 13, 19 }, { 5, 11, 17 }, { 11, 17, 23 }, { 10, 16, 22 }, { 2, 6, 10 }, { 3, 7, 11 }, { 7, 11, 15 },
	...
	private void render(Graphics g) {
		...
		if (unableToCommunicateWithOpponent) {
			...
			g.drawString(unableToCommunicateWithOpponentString, WIDTH / 5 - stringWidth / 2, HEIGHT / 5);
			return;
		}
